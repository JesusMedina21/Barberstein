...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Barberstein",


    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Barberstein",
    ...
    "copyright": "API-Barberstein Hecho por: Jesus Medina",
...
DATABASE_ROUTERS = ["django_mongodb_backend.routers.MongoRouter", "barberstein.routers.PermissionRouter"]
...
DJOSER = {
    ...
    [
        ...
        'http://localhost:8100/google', 
        'http://localhost:8100/facebook'
    ],
    'SERIALIZERS': {
...
LOGIN_REDIRECT_URL = 'http://localhost:8100/'
#LOGOUT_REDIRECT_URL = 'http://localhost:8100/'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    # Prevenir sobrescritura ANTES de cualquier asociación
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Barberstein',
    'DESCRIPTION': 'API REST utilizada como Backend para una Red Social de Barberias. Desarrollada en Django Rest, MongoDB, autenticacion mediante JWT, envio de correos, autenticacion con Google, almacenamiento de Imagenes y desplegue en Vercel',
    'VERSION': '1.0.0',
    'CONTACT': {
        'name': 'Barberstein',
    ...
    'TAGS': [
        ...
        {'name': 'Servicios', 'description': 'Operaciones relacionadas con los servicios publicados por las barberias'},
    ],
    'SWAGGER_UI_SETTINGS': {
