"""
URL configuration for barberstein project.
...
urlpatterns = [
    ...
    #REDIRECCIONAMIENTO
    re_path(r'^(?!api/docs/|api/old-turnos/|api/auth/o/login/google-oauth2/).*$', RedirectView.as_view(url='/admin/', permanent=False)),
